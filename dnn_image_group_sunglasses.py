...
def overlay_sunglasses(image, startX, startY, endX, endY, sunglasses, scale, height_scale=0.5, x_offset=0, y_offset=0):
    ...
    # 선글라스 위치
    eye_level_y = startY + y_offset + (h // 2) + 9
...
if __name__ == "__main__":
    ...
    # loop over the detections and apply sunglasses to each face
    ...
    output_path = os.path.join(args["output"], "output_image_group.png")
...
"""
<실행 명령어>
python dnn_image_group_sunglasses.py -i input_folder/group.jpg -p deploy.prototxt.txt -m res10_300x300_ssd_iter_140000.caffemodel \
